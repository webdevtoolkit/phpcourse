...
<body> 
 <form name="contact_frm" action="index2.php" method="post">
  <ul>
  ...
  <li><label>Enter password</label><input type="password" name="password1" id="password" /></li>
  <li><label>Retype password</label><input type="password" name="password2" id="confirm_password" /></li>
